...
class TypeSpeedGUI:
    def __init__(self):
        ...
        print(self.sample_label['text'])
        self.sample_label.grid(row=0, column=0, columnspan=2, padx=5, pady=5)

        self.input_entry = tk.Entry(self.frame, width=30, font=("Arial", 24))
        ...
        self.reset_buttom = tk.Button(self.frame, text="Reset", command=self.reset, font=("Arial",24))
        self.reset_buttom.grid(row=3, column=0, padx=5, pady=10,columnspan=3)
